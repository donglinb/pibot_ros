...
sudo apt-get -y --allow-unauthenticated  install ros-${ros_version}-ros-base ros-${ros_version}-slam-gmapping ros-${ros_version}-navigation ros-${ros_version}-xacro ros-${ros_version}-yocs-velocity-smoother ros-${ros_version}-robot-state-publisher ros-${ros_version}-joint-state-publisher ros-${ros_version}-teleop-twist-* ros-${ros_version}-rviz ros-${ros_version}-control-msgs ros-${ros_version}-kdl-parser-py ros-${ros_version}-tf2-geometry-msgs
